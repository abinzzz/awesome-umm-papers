...
![Showcase of the versatile abilities of the BAGEL model.](assets/figures/bagel.png)
...
![Comparison with open-source flagship models in vision generation and perception.](assets/figures/emu3.png)
...
![Gen-Searcher enables search-grounded generation in real-world knowledge-intensive scenarios.](assets/figures/gen-searcher.png)
...
![Overview of Lance's unified multimodal context modeling and dual-expert backbone.](assets/figures/lance.png)
...
![Overview of the LongCat-Next architecture under the Discrete Native Autoregression paradigm.](assets/figures/longcat-next.png)
...
![High-quality Unify-Agent samples showing unified multi-image generation and world-knowledge grounding.](assets/figures/unify-agent.png)
...
![Overview of the VideoDR construction pipeline.](assets/figures/videodr.png)
...
![MME-Unify benchmark diagram covering understanding, generation, and unified tasks.](assets/figures/mme-unify.png)
...
![Overview of Uni-MMMU's bidirectional generation-understanding task paradigms.](assets/figures/uni-mmmu.png)
